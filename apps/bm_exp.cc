...
private:
  ...
  static std::map<IString, PARA_BASE EVAL_BM_EXP::*> _param_dict;
...
/*--------------------------------------------------------------------------*/
std::map<IString, PARA_BASE EVAL_BM_EXP::*> EVAL_BM_EXP::_param_dict={
  {IString("iv"),    (PARA_BASE EVAL_BM_EXP::*) &EVAL_BM_EXP::_iv},
  {IString("pv"),    (PARA_BASE EVAL_BM_EXP::*) &EVAL_BM_EXP::_pv},
  {IString("td1"),   (PARA_BASE EVAL_BM_EXP::*) &EVAL_BM_EXP::_td1},
  {IString("tau1"),  (PARA_BASE EVAL_BM_EXP::*) &EVAL_BM_EXP::_tau1},
  {IString("td2"),   (PARA_BASE EVAL_BM_EXP::*) &EVAL_BM_EXP::_td2},
  {IString("tau2"),  (PARA_BASE EVAL_BM_EXP::*) &EVAL_BM_EXP::_tau2},
  {IString("period"),(PARA_BASE EVAL_BM_EXP::*) &EVAL_BM_EXP::_period},
  {IString("period"),(PARA_BASE EVAL_BM_EXP::*) &EVAL_BM_EXP::_period}
  };
/*--------------------------------------------------------------------------*/
